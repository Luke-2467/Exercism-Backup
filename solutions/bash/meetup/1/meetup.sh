...
debug(){
echo "days in given month: $days_in_given_month"
echo "year code: $year_code"
echo "month code: $month_code"
echo "century code: $century_code"
echo "date: 1"
echo "leap year indicator: $leap_year_indicator"
echo "day on the first: $day_on_the_first"
echo "current date: $current_date"
echo "last date of wanted day: $last_date_of_wanted_day"
}
...
century_code="${century_code[year_thousandth_and_hundreth]}"
